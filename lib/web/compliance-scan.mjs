...
// Usage: node compliance-scan.mjs --out <file> --base <url> --legal <json> --paths <json> --profile <name> [--waivers <json>] [--today YYYY-MM-DD]
...
const CHECKS = { ...core, ...abmahnung, ...sector, ...datenschutz };
